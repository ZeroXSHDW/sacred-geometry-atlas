(function () {
  ...
  function renderCharts() {
    ...
    $("#moduleChart").innerHTML = comparison.map((study) => {
      ...
      return `
      <div class="module-row" role="listitem" aria-label="${escapeHtml(studyShortName(study))}: ${study.bayCount} bays, module ${number(study.module)} ${escapeHtml(unitName)}; ${escapeHtml(study.axis)} axis; ${escapeHtml(studyDataLabel(study))} record">
