...
function noScriptFallback() {
  ...
  const note = schematicCount && measuredCount
    ? `The collection mixes schematic and measured records (${statusSummary}). Schematic = ${statusDefinitions.schematic || "illustrative proportions"} Measured = ${statusDefinitions.measured || "source-supported dimensions"} Enable JavaScript for interactive drawings, comparison, filters, and downloadable exports.`
    : measuredCount
      ? `The records are labeled measured and use source-supported dimensions. Counts: ${statusSummary}. Enable JavaScript for interactive drawings, comparison, filters, and downloadable exports.`
      : "The records are labeled schematic and use the Sacred Geometry Atlas proportional model; they are not a measured survey. Enable JavaScript for interactive drawings, comparison, filters, and downloadable exports.";
