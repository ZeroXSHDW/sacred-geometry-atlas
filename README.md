...
- Primary Atlas, Compare, and Method navigation uses real hash links, preserving open-in-new-tab, middle-click, and copy-link behavior while ordinary clicks retain in-place focus and history handling.
