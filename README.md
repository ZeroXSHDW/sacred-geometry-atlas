...
- The Method view keeps the current study in context with a study-aware deep link and dynamic return-to-study action, or returns to the filtered Atlas catalog when the current study is outside the active view.
