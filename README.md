...
- Shareable hash routes such as `#atlas/gothic/section/interior/axis` and focused comparisons such as `#compare/basilica,gothic`, plus Compare and Method views; browser history restores the selected context.
