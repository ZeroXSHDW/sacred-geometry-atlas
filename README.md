...
- The standalone collection page carries its own canonical, crawl, alternate-artifact, Open Graph, and X metadata, with deployment stamping those URLs to the final GitHub Pages origin while reusing the established Atlas preview card.
