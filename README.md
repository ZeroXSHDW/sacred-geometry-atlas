...
- The branded 404 keeps manifest and Apple touch-icon discovery rooted at the published project path, so missing-path recovery remains installable on GitHub Pages project URLs.
