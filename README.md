...
- Route-aware document descriptions and Open Graph/X titles now follow the active study, filtered catalog, comparison selection, or Method context in the browser, while the committed root metadata and branded preview remain the safe static fallback for crawlers.
