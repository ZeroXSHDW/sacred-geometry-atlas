...
- Each visible catalog, study, and comparison route also has a one-click Copy link action that copies the full URL, announces success or an accessible manual-selection fallback, and disappears from print output.
