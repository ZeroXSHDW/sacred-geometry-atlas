...
- A `prefers-contrast: more` layer strengthens muted text, boundaries, meters, selected-study markers, and focus rings without changing the default dark palette.
