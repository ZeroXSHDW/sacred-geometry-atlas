...
- The geometry data and app scripts load in document order with deferred execution, allowing the static route shell and recovery links to paint before interactive boot while preserving the no-JavaScript fallback.
