...
- Search across study names, references, notes, detail vocabulary, numeric geometry dimensions, and derived ratios, plus typology, location, and measured/schematic status filtering with an explicit provenance key.
